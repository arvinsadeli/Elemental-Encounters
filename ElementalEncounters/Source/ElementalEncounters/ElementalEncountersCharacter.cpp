...
void AElementalEncountersCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
	SetStatus();
...
void AElementalEncountersCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AElementalEncountersCharacter::Move);

		//Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AElementalEncountersCharacter::Look);

	}

}

void AElementalEncountersCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
